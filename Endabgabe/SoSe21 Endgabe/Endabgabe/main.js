...
(function (Endabgabe) {
    ...
    function handleload() {
        ...
        function ballLeader() {
            ...
            //calculate new random pos inside precision radius of the player
    ...
    function updateAnimation() {
        ...
        for (let movable of listOfMoveables) {
            ...
            if (movable instanceof Endabgabe.Linesman) {
                ...
                //calculate distance between player and ball (subtract radius of both for real collision detection)
